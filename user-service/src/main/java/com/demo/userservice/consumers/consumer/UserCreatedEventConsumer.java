package com.demo.userservice.consumers.consumer;


import com.demo.userservice.consumers.model.UserCreatedEvent;
...
public class UserCreatedEventConsumer {
    ...
    public void consumeCreatedUserEvent(@Payload UserCreatedEvent eventData,
        ...
        userCreateRequest.setUsername(consumerRecord.key());
        userCreateRequest.setEmail(eventData.getEmail());

...
public final class AuthServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.demo.authservice.AuthService";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<com.demo.authservice.Token,
      com.demo.authservice.ValidationResponse> METHOD_VALIDATE_TOKEN =
      io.grpc.MethodDescriptor.<com.demo.authservice.Token, com.demo.authservice.ValidationResponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "com.demo.authservice.AuthService", "validateToken"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.demo.authservice.Token.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.demo.authservice.ValidationResponse.getDefaultInstance()))
          .build();
  ...
  public static abstract class AuthServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void validateToken(com.demo.authservice.Token request,
        io.grpc.stub.StreamObserver<com.demo.authservice.ValidationResponse> responseObserver) {
  ...
  public static final class AuthServiceBlockingStub extends io.grpc.stub.AbstractStub<AuthServiceBlockingStub> {
    ...
    /**
     */
    public com.demo.authservice.ValidationResponse validateToken(com.demo.authservice.Token request) {
  ...
  public static final class AuthServiceFutureStub extends io.grpc.stub.AbstractStub<AuthServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.demo.authservice.ValidationResponse> validateToken(
        com.demo.authservice.Token request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_VALIDATE_TOKEN:
          serviceImpl.validateToken((com.demo.authservice.Token) request,
              (io.grpc.stub.StreamObserver<com.demo.authservice.ValidationResponse>) responseObserver);
          break;
        default:
  ...
  private static final class AuthServiceDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.demo.authservice.Auth.getDescriptor();
    }
  }
